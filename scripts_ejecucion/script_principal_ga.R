...
# prob_mutacion <- runif(n = n, min = 0, max = 0.25)
...
system.time(resultados_facil <- mapply(pruebas_ga,
                                       num_pruebas              = 10,
...
# save(resultados_facil, file = paste0("data/sudoku_facil_", Sys.Date(), ".RData"))
